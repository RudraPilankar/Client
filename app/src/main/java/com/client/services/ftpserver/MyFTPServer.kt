...
class MyFTPServer(private val context: Context, private val deviceId: String) {
    ...
    fun run() {
        ...
        Log.d("MyFTPServer", "Device ID: $deviceId")
        ...
        try {
            ...
            while (serverRunning) {
                try {
                    ...
                    val w = MyFTPWorker(context, client, dataPort, deviceId)
